 ...
 */
@ServiceConfig(
        actionName = ActionNames.INSERT_SERVICE_USER,
        importantParameter = {
    ...
    @OutputConfig(name = "type", typeEnum = TypeEnum.CHAR_32, desc = "类型")
        ...
        description = "新增客服帐号")
public class InsertServiceUserServiceImpl implements Service {
    ...
    public void execute(MessageContext messageContext) {
        ...
        if(userEntity == null) {
            ...
            this.serviceUserLocalService.insertServerUser(parameterMap);
